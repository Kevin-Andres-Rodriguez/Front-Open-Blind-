      ...
      <div class="login-section">
        <form @submit.prevent="register">          
          ...
          <div class="input">
            ...
            <input id="fechaNacimientoUsuario" type="date" required v-model="form.fechaNacimientoUsuario" />
          </div>
  ...
  methods: {
    ...
    async register() {
      ...
      if (!phoneRegex.test(this.form.telefonoUsuario)) {
        Swal.fire('Error', 'El número de teléfono debe contener exactamente 10 dígitos.', 'error');
        return;
      }
