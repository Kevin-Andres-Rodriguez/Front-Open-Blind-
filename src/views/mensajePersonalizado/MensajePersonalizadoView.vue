    ...
    <div :class="['off-canvas', { open: isOffCanvasOpen }]">
      ...
      <div class="off-canvas-body">
        <form @submit.prevent="submitForm" class="form">
          ...
          <div class="form-group">
            <label for="nombre_usuario" class="form-label">Mensaje<span class="required">*</span>:</label>
            <input type="text" id="nombre_usuario" v-model="form.nombre_usuario" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="apellido_usuario" class="form-label">Contacto <span class="required">*</span>:</label>
...
export default {
  ...
  methods: {
    openOffCanvas(action) {
      this.offCanvasTitle = action === 'add' ? 'Agregar Usuario' : 'Editar Mensaje Personalizado';
