      ...
      <div class="off-canvas-body">
        <form @submit.prevent="submitForm" class="form">
          ...
          <div class="form-group">
            ...
            <input type="email" id="correoubicacion_ruta" v-model="form.correoubicacion_ruta" class="form-control" required>
          </div>
          <div class="form-group">
  ...
  methods: {
    ...
    submitForm() {
      alert(`
        ...
        Descripcion: ${this.form.descripcion_ruta}
        Ubicacion: ${this.form.ubicacion_ruta}
