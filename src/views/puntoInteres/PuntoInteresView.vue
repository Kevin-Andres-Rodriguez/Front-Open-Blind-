    ...
    <div :class="['off-canvas', { open: isOffCanvasOpen }]">
      ...
      <div class="off-canvas-body">
        <form @submit.prevent="submitForm" class="form">
          ...
          <div class="form-group">
            <label for="correo_usuario" class="form-label">Ubicación <span class="required">*</span>:</label>
...
export default {
  ...
  methods: {
    openOffCanvas(action) {
      this.offCanvasTitle = action === 'add' ? 'Agregar Usuario' : 'Editar Punto de Interes';
